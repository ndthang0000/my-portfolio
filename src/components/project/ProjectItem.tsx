...
const ProjectItem = () => {
  return (
    <div>
      ...
      <div className="leading-6 shadow-inner rounded-2xl w-6/12 px-6 py-4 text-sm bg-[linear-gradient(266deg,rgba(105,59,147,0.4)0%,rgba(110,191,244,0.22)77%,rgba(70,144,212,0)100%)]">
