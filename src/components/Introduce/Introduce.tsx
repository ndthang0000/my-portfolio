  ...
  return (
    <div className='px-4'>
      ...
      <div>
        ...
        <p className='text-base mb-16'>Currently, I'm a Software Engineer at
          <Link href={'http://gameloft.com'} target='_blank'><Image
          ...
          Gameloft</p>
        <p className='text-base lg:text-lg font-light lg:w-[900px]'>A self-taught UI/UX designer, functioning in the industry for 3+ years now.
